...
public class WB_Distance {
	 ...
	 */
	public static double sqDistance(final WB_XYZ p, final WB_XYZ q) {
	 ...
	 * @return distance
	 */
	public static double distance(final WB_XYZ p, final WB_XYZ q) {
	 ...
	 * @return squared distance
	 */
	public static double sqDistance(final WB_XYZW p, final WB_XYZW q) {
	 ...
	 * @return distance
	 */
	public static double distance(final WB_XYZW p, final WB_XYZW q) {
		return Math.sqrt(sqDistance(p, q));
	}
	 ...
	 * @return squared distance
	 */
	public static double sqDistance(final WB_XYZ p, final WB_Plane P) {
	 ...
	 * @return distance
	 */
	public static double distance(final WB_XYZ p, final WB_Plane P) {
	 ...
	 * @return squared distance
	 */
	public static double sqDistance(final WB_XYZ p, final WB_Segment S) {
		final WB_Vector ab = S.getEnd().subToVector(S.getOrigin());
		final WB_Vector ac = p.subToVector(S.getOrigin());
		final WB_Vector bc = p.subToVector(S.getEnd());
	 ...
	 * @return distance
	 */
	public static double distance(final WB_XYZ p, final WB_Segment S) {
	 ...
	 * @return squared distance
	 */
	public static double sqDistanceToSegment(final WB_XYZ p, final WB_Point a,
			final WB_Point b) {
		final WB_Vector ab = b.subToVector(a);
		final WB_Vector ac = p.subToVector(a);
		final WB_Vector bc = p.subToVector(b);
		final double e = ac.dot(ab);
		if (e <= 0) {
			return ac.dot(ac);
		}
	 ...
	 * @return distance
	 */
	public static double distanceToSegment(final WB_XYZ p, final WB_Point a,
			final WB_Point b) {
	 ...
	 * @return squared distance
	 */
	public static double sqDistance(final WB_XYZ p, final WB_Line L) {
		final WB_Vector ab = L.getDirection();
		final WB_Vector ac = p.subToVector(L.getOrigin());
		final double e = ac.dot(ab);
		final double f = ab.dot(ab);
		return ac.dot(ac) - e * e / f;
	}
	 ...
	 * @return distance
	 */
	public static double distance(final WB_XYZ p, final WB_Line L) {
	 ...
	 * @return squared distance
	 */
	public static double sqDistanceToLine(final WB_XYZ p, final WB_Point a,
			final WB_Point b) {
		final WB_Vector ab = b.subToVector(a);
		final WB_Vector ac = p.subToVector(a);
		final double e = ac.dot(ab);
	 ...
	 * @return distance
	 */
	public static double distanceToLine(final WB_XYZ p, final WB_Point a,
			final WB_Point b) {
	 ...
	 * @return squared distance
	 */
	public static double sqDistance(final WB_XYZ p, final WB_Ray R) {
	 ...
	 * @return distance
	 */
	public static double distance(final WB_XYZ p, final WB_Ray R) {
	 ...
	 * @return squared distance
	 */
	public static double sqDistanceToRay(final WB_XYZ p, final WB_Point a,
			final WB_Point b) {
		final WB_Vector ab = b.subToVector(a);
		final WB_Vector ac = p.subToVector(a);
		final double e = ac.dot(ab);
	 ...
	 * @return distance
	 */
	public static double distanceToRay(final WB_XYZ p, final WB_Point a,
			final WB_Point b) {
	 ...
	 * @return squared distance
	 */
	public static double sqDistance(final WB_XYZ p, final WB_AABB AABB) {
		double sqDist = 0;
		double v = p.x;
		if (v < AABB.min.x) {
	 ...
	 * @return distance
	 */
	public static double distance(final WB_XYZ p, final WB_AABB AABB) {
	 ...
	 * @return squared distance
	 */
	public static double sqDistance(final WB_XYZ p, final WB_Polygon poly) {
		...
		for (int i = 0; i < n; i++) {
			T = tris.get(i);
			tmp = WB_ClosestPoint.closestPoint(p, T);
