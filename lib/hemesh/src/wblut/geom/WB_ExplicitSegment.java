...
public class WB_ExplicitSegment extends WB_Linear implements WB_Segment {
	 ...
	 * @param l length
	 */
	public WB_ExplicitSegment(final WB_Point o, final WB_Vector d,
			final double l) {
		super(o, d);
		length = l;
		end = new WB_Point(direction);
	 ...
	 * @param l length
	 */
	public void set(final WB_Point o, final WB_Vector d, final double l) {
		super.set(o, d);
		length = l;
		end = new WB_Point(direction);
		end.mult(l).add(origin);
	 ...
	 * @param p2 end point
	 */
	public WB_ExplicitSegment(final WB_Point p1, final WB_Point p2) {
		super.set(p1, p2);
		end = p2.get();
	...
	public WB_ExplicitSegment(final double p1x, final double p1y,
			...
			final double p2z) {
		super(new WB_Point(p1x, p1y, p1z), new WB_Point(p2x, p2y, p2z));
		end = new WB_Point(p2x, p2y, p2z);
