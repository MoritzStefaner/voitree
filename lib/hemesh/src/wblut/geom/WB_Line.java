...
public class WB_Line extends WB_Linear {
	 ...
	 * @param d direction
	 */
	public WB_Line(final WB_Point o, final WB_Vector d) {
		super(o, d);
	 ...
	 * @param d direction
	 */
	public WB_Line(final WB_Point o, final WB_Normal d) {
		super(o, d);
	 ...
	 * @param d direction
	 */
	public void set(final WB_Point o, final WB_Normal d) {
		super.set(o, d);
	 ...
	 */
	public WB_Line(final WB_Point p1, final WB_Point p2) {
		super(p1, p2);
