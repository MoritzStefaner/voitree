...
public class WB_Ray extends WB_Linear {
	 ...
	 * @param d direction
	 */
	public WB_Ray(final WB_Point o, final WB_Vector d) {
		origin = o.get();
		direction = d.get();
		direction.normalize();
	 ...
	 */
	public WB_Ray(final WB_Point p1, final WB_Point p2) {
		origin = p1.get();
	...
	public WB_Ray(final double p1x, final double p1y, final double p1z,
		...
		origin = new WB_Point(p1x, p1y, p1z);
		direction = new WB_Vector(p2x - p1x, p2y - p1y, p2z - p1z);
		direction.normalize();
