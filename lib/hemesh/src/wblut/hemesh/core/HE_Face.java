...
public class HE_Face {
	 ...
	 * @return normal
	 */
	public WB_Normal getFaceNormal() {
		if (_halfedge == null) {
			return null;
		}
	...
	public double getFaceArea() {
		...
		final WB_Normal n = getFaceNormal();
	 ...
	 * @return vertices
	 */
	public ArrayList<HE_Vertex> getFaceVertices() {
		if (!_sorted) {
			sort();
		}
		final ArrayList<HE_Vertex> fv = new ArrayList<HE_Vertex>();
		if (_halfedge == null) {
			return fv;
		}
		HE_Halfedge he = _halfedge;
	 ...
	 * @return halfedges
	 */
	public ArrayList<HE_Halfedge> getFaceHalfedges() {
		if (!_sorted) {
			sort();
		}
		final ArrayList<HE_Halfedge> fhe = new ArrayList<HE_Halfedge>();
		if (_halfedge == null) {
			return fhe;
		}
		HE_Halfedge he = _halfedge;
	 ...
	 * @return edges
	 */
	public ArrayList<HE_Edge> getFaceEdges() {
		if (!_sorted) {
			sort();
		}
		final ArrayList<HE_Edge> fe = new ArrayList<HE_Edge>();
		if (_halfedge == null) {
			return fe;
		}
		HE_Halfedge he = _halfedge;
	 ...
	 */
	public ArrayList<WB_IndexedTriangle2D> triangulate() {
	...
	public WB_ExplicitPolygon toPolygon() {
		...
		HE_Halfedge he = _halfedge;
		do {
			points[i] = new WB_Point(he.getVertex().x, he.getVertex().y, he
					.getVertex().z);
	 ...
	 */
	public ArrayList<HE_Face> getNeighborFaces() {
		if (!isSorted()) {
			sort();
		}
		final ArrayList<HE_Face> ff = new ArrayList<HE_Face>();
		if (getHalfedge() == null) {
			return ff;
		}
