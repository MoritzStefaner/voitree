...
public abstract class HE_MeshStructure {
	 ...
	 *
	 * @return all vertices as ArrayList<HE_Vertex>
	 */
	public final ArrayList<HE_Vertex> getVerticesAsArrayList() {
	 ...
	 *
	 * @return all vertices as ArrayList<HE_Halfedge>
	 */
	public final ArrayList<HE_Halfedge> getHalfedgesAsArrayList() {
	 ...
	 * Edges as arrayList.
	 *
	 * @return all vertices as ArrayList<HE_Edge>
	 */
	public final ArrayList<HE_Edge> getEdgesAsArrayList() {
		final ArrayList<HE_Edge> edges = new ArrayList<HE_Edge>();
	 ...
	 * Adds vertices.
	 *
	 * @param vertices vertices to add as ArrayList<HE_Vertex>
	 */
	 ...
	 * Adds edges.
	 *
	 * @param edges edges to add as ArrayList<HE_Edge>
	 */
	 ...
	 * Adds halfedges.
	 *
	 * @param halfedges halfedges to add as ArrayList<HE_Halfedge>
	 */
	 ...
	 * Removes vertices.
	 *
	 * @param vertices vertices to remove as ArrayList<HE_Vertex>
	 */
	 ...
	 * Removes edges.
	 *
	 * @param edges edges to remove as ArrayList<HE_Edge>
	 */
	 ...
	 * Removes halfedges.
	 *
	 * @param halfedges halfedges to remove as ArrayList<HE_Halfedge>
	 */
	 ...
	 * Faces as arrayList.
	 *
	 * @return all vertices as ArrayList<HE_Face>
	 */
	public final ArrayList<HE_Face> getFacesAsArrayList() {
		final ArrayList<HE_Face> faces = new ArrayList<HE_Face>();
	 ...
	 * Removes faces.
	 *
	 * @param faces faces to remove as ArrayList<HE_Face>
	 */
	...
	public WB_AABB getAABB() {
		...
		final WB_Point min = new WB_Point(result[0], result[1], result[2]);
		final WB_Point max = new WB_Point(result[3], result[4], result[5]);
