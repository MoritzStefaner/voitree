...
public class HE_Edge {
	...
	public WB_Point getEdgeCenter() {
		...
		final WB_Point center = getStartVertex().addAndCopy(getEndVertex())
				.mult(0.5);
		return center;
	...
	public WB_Vector getEdgeTangent() {
		...
		final WB_Vector v = getEndVertex().subToVector(getStartVertex());
		v.normalize();
		return v;
	}
	 ...
	 * @return edge normal
	 */
	public WB_Normal getEdgeNormal() {

		if ((getFirstFace() == null) && (getSecondFace() == null)) {
			return null;
		}
		final WB_Normal n1 = (getFirstFace() != null) ? getFirstFace()
				.getFaceNormal() : new WB_Normal(0, 0, 0);
		final WB_Normal n2 = (getSecondFace() != null) ? getSecondFace()
				.getFaceNormal() : new WB_Normal(0, 0, 0);
		final WB_Normal n = new WB_Normal(n1.x + n2.x, n1.y + n2.y, n1.z + n2.z);
		n.normalize();
		return n;
	}
	...
	public double getDihedralAngle() {
		...
		if ((getFirstFace() == null) || (getSecondFace() == null)) {
			...
			final WB_Normal n1 = getFirstFace().getFaceNormal();
			final WB_Normal n2 = getSecondFace().getFaceNormal();
