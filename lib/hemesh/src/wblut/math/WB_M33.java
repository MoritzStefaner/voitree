...
public class WB_M33 {
	 ...
	 * @return result
	 */
	public static WB_Normal mult(final WB_Normal v, final WB_M33 m) {
		return new WB_Normal(v.x * m.m11 + v.y * m.m21 + v.z * m.m31, v.x
				* m.m12 + v.y * m.m22 + v.z * m.m32, v.x * m.m13 + v.y * m.m23
				+ v.z * m.m33);
	}
	 ...
	 * @param result result
	 */
	public static void multInto(final WB_Normal v, final WB_M33 m,
	 ...
	 * @return result
	 */
	public static WB_Normal mult(final WB_M33 m, final WB_Normal v) {
		return new WB_Normal(v.x * m.m11 + v.y * m.m12 + v.z * m.m13, v.x
				* m.m21 + v.y * m.m22 + v.z * m.m23, v.x * m.m31 + v.y * m.m32
				+ v.z * m.m33);
	}
	 ...
	 * @param result result
	 */
	public static void multInto(final WB_M33 m, final WB_Normal v,
			final WB_Normal result) {
		result.set(v.x * m.m11 + v.y * m.m12 + v.z * m.m13, v.x * m.m21 + v.y
				* m.m22 + v.z * m.m23, v.x * m.m31 + v.y * m.m32 + v.z * m.m33);
	}
	 ...
	 */
	public static WB_Vector Cramer3(final double a1, final double b1,
	 ...
	 */
	public static WB_M33 covarianceMatrix(final WB_Point[] points,
			final int numPoints) {
