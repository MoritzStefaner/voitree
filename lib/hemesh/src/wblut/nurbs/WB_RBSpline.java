...
public class WB_RBSpline extends WB_BSpline {
	...
	public WB_RBSpline(final WB_Point[] controlPoints, final WB_Knot knot) {
	...
	public WB_RBSpline(final WB_Homogeneous[] controlPoints, final WB_Knot knot) {
	...
	public WB_RBSpline(final WB_Point[] controlPoints, final int order) {
		this(controlPoints, new WB_Knot(controlPoints.length, order));
	...
	@Override
	public WB_RBSpline refineKnot(final WB_Knot K) {
