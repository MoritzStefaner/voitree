 ...
 *
 */
public class WB_Homogeneous extends WB_XYZW {
	 ...
	 * @param v
	 */
	public WB_Homogeneous(final WB_XYZ v, final double w) {
		x = w * v.x;
		y = w * v.y;
		z = w * v.z;
		this.w = w;
	...
	public void set(final WB_XYZ v, final double w, final boolean atInfinity) {
